...
export class FundingUpdated__Params {
  ...
  get longPositionSize(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }

  get shortPositionSize(): BigInt {
...
export class ExchangeOwnershipTransferred extends ethereum.Event {
  get params(): ExchangeOwnershipTransferred__Params {
    return new ExchangeOwnershipTransferred__Params(this);
  }
}

export class ExchangeOwnershipTransferred__Params {
  _event: ExchangeOwnershipTransferred;

  constructor(event: ExchangeOwnershipTransferred) {
    this._event = event;
  }
...
export class Exchange__estimateSwapResultResponseStruct extends ethereum.Tuple {
  get tick(): i32 {
    return this[0].toI32();
  }
...
export class Exchange__estimateSwapInputParamsStruct extends ethereum.Tuple {
  get baseToken(): Address {
...
export class Exchange__getFundingGrowthGlobalAndTwapsResultFundingGrowthGlobalStruct extends ethereum.Tuple {
  get twLongPremiumX96(): BigInt {
    return this[0].toBigInt();
  }

  get twShortPremiumX96(): BigInt {
    return this[1].toBigInt();
  }
}

export class Exchange__getFundingGrowthGlobalAndTwapsResult {
  value0: Exchange__getFundingGrowthGlobalAndTwapsResultFundingGrowthGlobalStruct;
  value1: BigInt;
  value2: BigInt;
  ...
  getFundingGrowthGlobal(): Exchange__getFundingGrowthGlobalAndTwapsResultFundingGrowthGlobalStruct {
    return this.value0;
  }
...
export class Exchange__getGlobalFundingGrowthInfoResultFundingGrowthGlobalStruct extends ethereum.Tuple {
  get twLongPremiumX96(): BigInt {
    return this[0].toBigInt();
  }
...
export class Exchange__getGlobalFundingGrowthInfoResult {
  value0: BigInt;
  value1: Exchange__getGlobalFundingGrowthInfoResultFundingGrowthGlobalStruct;
  ...
  getLastSettledTimestamp(): BigInt {
    return this.value0;
  }

  getFundingGrowthGlobal(): Exchange__getGlobalFundingGrowthInfoResultFundingGrowthGlobalStruct {
    return this.value1;
  }
}
...
export class Exchange__internalSwapResultValue0Struct extends ethereum.Tuple {
  get base(): BigInt {
    return this[0].toBigInt();
  }
...
export class Exchange__internalSwapInputParamsStruct extends ethereum.Tuple {
  get trader(): Address {
    return this[0].toAddress();
  }
...
export class Exchange__settleFundingGlobalResultFundingGrowthGlobalStruct extends ethereum.Tuple {
  get twLongPremiumX96(): BigInt {
    return this[0].toBigInt();
  }
...
export class Exchange extends ethereum.SmartContract {
  ...
  estimateSwap(
    params: Exchange__estimateSwapInputParamsStruct
  ): Exchange__estimateSwapResultResponseStruct {
    let result = super.call(
      "estimateSwap",
      "estimateSwap((address,bool,bool,uint256,uint256,uint256,uint160,bytes32)):((int24,uint256,uint256,uint256))",
      [ethereum.Value.fromTuple(params)]
    );

    return changetype<Exchange__estimateSwapResultResponseStruct>(
      result[0].toTuple()
    );
  }
  ...
  try_estimateSwap(
    params: Exchange__estimateSwapInputParamsStruct
  ): ethereum.CallResult<Exchange__estimateSwapResultResponseStruct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Exchange__estimateSwapResultResponseStruct>(value[0].toTuple())
    );
  }
  ...
  getFundingGrowthGlobalAndTwaps(
    baseToken: Address
  ): Exchange__getFundingGrowthGlobalAndTwapsResult {
    let result = super.call(
      "getFundingGrowthGlobalAndTwaps",
      "getFundingGrowthGlobalAndTwaps(address):((int256,int256),uint256,uint256)",
      [ethereum.Value.fromAddress(baseToken)]
    );

    return changetype<Exchange__getFundingGrowthGlobalAndTwapsResult>(
      new Exchange__getFundingGrowthGlobalAndTwapsResult(
        changetype<
          Exchange__getFundingGrowthGlobalAndTwapsResultFundingGrowthGlobalStruct
        >(result[0].toTuple()),
        result[1].toBigInt(),
        result[2].toBigInt()
      )
  ...
  try_getFundingGrowthGlobalAndTwaps(
    baseToken: Address
  ): ethereum.CallResult<Exchange__getFundingGrowthGlobalAndTwapsResult> {
    let result = super.tryCall(
      "getFundingGrowthGlobalAndTwaps",
      "getFundingGrowthGlobalAndTwaps(address):((int256,int256),uint256,uint256)",
      [ethereum.Value.fromAddress(baseToken)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Exchange__getFundingGrowthGlobalAndTwapsResult>(
        new Exchange__getFundingGrowthGlobalAndTwapsResult(
          changetype<
            Exchange__getFundingGrowthGlobalAndTwapsResultFundingGrowthGlobalStruct
          >(value[0].toTuple()),
  ...
  getGlobalFundingGrowthInfo(
    baseToken: Address
  ): Exchange__getGlobalFundingGrowthInfoResult {
    let result = super.call(
      "getGlobalFundingGrowthInfo",
      "getGlobalFundingGrowthInfo(address):(uint256,(int256,int256))",
      [ethereum.Value.fromAddress(baseToken)]
    );

    return new Exchange__getGlobalFundingGrowthInfoResult(
      result[0].toBigInt(),
      changetype<
        Exchange__getGlobalFundingGrowthInfoResultFundingGrowthGlobalStruct
      >(result[1].toTuple())
    );
  }

  try_getGlobalFundingGrowthInfo(
    baseToken: Address
  ): ethereum.CallResult<Exchange__getGlobalFundingGrowthInfoResult> {
    let result = super.tryCall(
      "getGlobalFundingGrowthInfo",
      "getGlobalFundingGrowthInfo(address):(uint256,(int256,int256))",
      [ethereum.Value.fromAddress(baseToken)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Exchange__getGlobalFundingGrowthInfoResult(
        value[0].toBigInt(),
        changetype<
          Exchange__getGlobalFundingGrowthInfoResultFundingGrowthGlobalStruct
        >(value[1].toTuple())
  ...
  getInsuranceFundFeeRatio(baseToken: Address, isBaseToQuote: boolean): BigInt {
    let result = super.call(
      "getInsuranceFundFeeRatio",
      "getInsuranceFundFeeRatio(address,bool):(uint256)",
      [
        ethereum.Value.fromAddress(baseToken),
        ethereum.Value.fromBoolean(isBaseToQuote)
      ]
    );
  ...
  internalSwap(
    params: Exchange__internalSwapInputParamsStruct
  ): Exchange__internalSwapResultValue0Struct {
    let result = super.call(
      "internalSwap",
      "internalSwap((address,address,bool,bool,bool,uint256,uint160)):((uint256,uint256,int256,int256,uint256,uint256,int256,uint256,int24,bool))",
      [ethereum.Value.fromTuple(params)]
    );

    return changetype<Exchange__internalSwapResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_internalSwap(
    params: Exchange__internalSwapInputParamsStruct
  ): ethereum.CallResult<Exchange__internalSwapResultValue0Struct> {
    let result = super.tryCall(
      "internalSwap",
      "internalSwap((address,address,bool,bool,bool,uint256,uint160)):((uint256,uint256,int256,int256,uint256,uint256,int256,uint256,int24,bool))",
      [ethereum.Value.fromTuple(params)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Exchange__internalSwapResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  isOverPriceSpreadTimestamp(baseToken: Address): boolean {
    let result = super.call(
      "isOverPriceSpreadTimestamp",
      "isOverPriceSpreadTimestamp(address):(bool)",
      [ethereum.Value.fromAddress(baseToken)]
    );
  ...
  try_isOverPriceSpreadTimestamp(
    baseToken: Address
  ...
  settleFundingGlobal(
    baseToken: Address
  ): Exchange__settleFundingGlobalResultFundingGrowthGlobalStruct {
    let result = super.call(
      "settleFundingGlobal",
      "settleFundingGlobal(address):((int256,int256))",
      [ethereum.Value.fromAddress(baseToken)]
    );
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Exchange__settleFundingGlobalResultFundingGrowthGlobalStruct>(
        value[0].toTuple()
      )
    );
  }
...
export class InternalSwapCall extends ethereum.Call {
  get inputs(): InternalSwapCall__Inputs {
    return new InternalSwapCall__Inputs(this);
  }

  get outputs(): InternalSwapCall__Outputs {
    return new InternalSwapCall__Outputs(this);
  }
}

export class InternalSwapCall__Inputs {
  _call: InternalSwapCall;

  constructor(call: InternalSwapCall) {
    this._call = call;
  }

  get params(): InternalSwapCallParamsStruct {
    return changetype<InternalSwapCallParamsStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
}

export class InternalSwapCall__Outputs {
  _call: InternalSwapCall;
  ...
  get value0(): InternalSwapCallValue0Struct {
    return changetype<InternalSwapCallValue0Struct>(
      this._call.outputValues[0].value.toTuple()
    );
  }
}

export class InternalSwapCallParamsStruct extends ethereum.Tuple {
  get trader(): Address {
    return this[0].toAddress();
  }
...
export class InternalSwapCallValue0Struct extends ethereum.Tuple {
  get base(): BigInt {
    return this[0].toBigInt();
  }
...
export class SettleFundingGlobalCall extends ethereum.Call {
  get inputs(): SettleFundingGlobalCall__Inputs {
    return new SettleFundingGlobalCall__Inputs(this);
  }

  get outputs(): SettleFundingGlobalCall__Outputs {
    return new SettleFundingGlobalCall__Outputs(this);
  }
}

export class SettleFundingGlobalCall__Inputs {
  _call: SettleFundingGlobalCall;

  constructor(call: SettleFundingGlobalCall) {
    this._call = call;
  }
...
export class SettleFundingGlobalCall__Outputs {
  _call: SettleFundingGlobalCall;
  ...
  get fundingGrowthGlobal(): SettleFundingGlobalCallFundingGrowthGlobalStruct {
    return changetype<SettleFundingGlobalCallFundingGrowthGlobalStruct>(
      this._call.outputValues[0].value.toTuple()
    );
  }
}

export class SettleFundingGlobalCallFundingGrowthGlobalStruct extends ethereum.Tuple {
  get twLongPremiumX96(): BigInt {
    return this[0].toBigInt();
  }
...
export class UpdateOverPriceSpreadTimestampCall extends ethereum.Call {
  get inputs(): UpdateOverPriceSpreadTimestampCall__Inputs {
    return new UpdateOverPriceSpreadTimestampCall__Inputs(this);
  }

  get outputs(): UpdateOverPriceSpreadTimestampCall__Outputs {
    return new UpdateOverPriceSpreadTimestampCall__Outputs(this);
  }
}

export class UpdateOverPriceSpreadTimestampCall__Inputs {
  _call: UpdateOverPriceSpreadTimestampCall;

  constructor(call: UpdateOverPriceSpreadTimestampCall) {
    this._call = call;
  }
...
export class UpdateOverPriceSpreadTimestampCall__Outputs {
  _call: UpdateOverPriceSpreadTimestampCall;
