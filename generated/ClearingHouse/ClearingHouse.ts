...
export class PlatformFundChanged extends ethereum.Event {
  get params(): PlatformFundChanged__Params {
    return new PlatformFundChanged__Params(this);
  }
}

export class PlatformFundChanged__Params {
  _event: PlatformFundChanged;

  constructor(event: PlatformFundChanged) {
    this._event = event;
  }

  get platformFundArg(): Address {
    return this._event.parameters[0].value.toAddress();
  }
}
...
export class Repeg extends ethereum.Event {
  get params(): Repeg__Params {
    return new Repeg__Params(this);
  }
}

export class Repeg__Params {
  _event: Repeg;

  constructor(event: Repeg) {
    this._event = event;
  }
...
export class ClearingHouse extends ethereum.SmartContract {
  ...
  addLiquidity(
    ...
    let result = super.call(
      "addLiquidity",
      "addLiquidity((address,uint128,uint256)):((uint256,uint256,uint128))",
  ...
  getMaker(): Address {
    let result = super.call("getMaker", "getMaker():(address)", []);

    return result[0].toAddress();
  }

  try_getMaker(): ethereum.CallResult<Address> {
    let result = super.tryCall("getMaker", "getMaker():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_getPlatformFund(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getPlatformFund",
      "getPlatformFund():(address)",
      []
  ...
  isAbleRepeg(baseToken: Address): boolean {
    let result = super.call("isAbleRepeg", "isAbleRepeg(address):(bool)", [
  ...
  try_isAbleRepeg(baseToken: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("isAbleRepeg", "isAbleRepeg(address):(bool)", [
      ethereum.Value.fromAddress(baseToken)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  removeLiquidity(
    ...
    let result = super.call(
      "removeLiquidity",
      "removeLiquidity((address,uint128,uint256)):((uint256,uint256))",
      [ethereum.Value.fromTuple(params)]
    );
...
export class RepegCall extends ethereum.Call {
  get inputs(): RepegCall__Inputs {
    return new RepegCall__Inputs(this);
  }

  get outputs(): RepegCall__Outputs {
    return new RepegCall__Outputs(this);
  }
}

export class RepegCall__Inputs {
  _call: RepegCall;

  constructor(call: RepegCall) {
    this._call = call;
  }
...
export class RepegCall__Outputs {
  _call: RepegCall;
...
export class SetPlatformFundCall extends ethereum.Call {
  get inputs(): SetPlatformFundCall__Inputs {
    return new SetPlatformFundCall__Inputs(this);
  }

  get outputs(): SetPlatformFundCall__Outputs {
    return new SetPlatformFundCall__Outputs(this);
  }
}

export class SetPlatformFundCall__Inputs {
  _call: SetPlatformFundCall;

  constructor(call: SetPlatformFundCall) {
    this._call = call;
  }
...
export class SetPlatformFundCall__Outputs {
  _call: SetPlatformFundCall;
