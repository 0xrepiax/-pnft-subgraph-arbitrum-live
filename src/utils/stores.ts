...
export function formatTraderMarketId(
  trader: Address,
  baseToken: Address
): string {
...
export function getOrCreateTraderMarket(
  traderAddr: Address,
  baseToken: Address
): TraderMarket {
...
export function getOrCreateOpenOrder(
  ...
  const openOrderId = formatOpenOrderId(
    makerAddr,
    baseToken,
    lowerTick,
    upperTick
...
export function formatTraderTokenBalanceId(
  traderAddr: Address,
  tokenAddr: Address
): string {
...
export function getOrCreateTraderTokenBalance(
  traderAddr: Address,
  tokenAddr: Address
): TraderTokenBalance {
  const traderTokenBalanceId = formatTraderTokenBalanceId(
    traderAddr,
    tokenAddr
  );
...
export function getOrCreateProtocolTokenBalance(
  tokenAddr: Address
): ProtocolTokenBalance {
